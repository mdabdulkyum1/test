    ...
    return (
      <section className="bg-frost-green py-12">
        ...
        <div className="w-5/6 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-white shadow-lg rounded-lg" data-aos="fade-right" data-aos-easing="linear"
     data-aos-duration="1500">
          ...
          <div className="p-6 bg-white shadow-lg rounded-lg" data-aos="fade-center" data-aos-easing="linear"
     data-aos-duration="1500">
          ...
          <div className="p-6 bg-white shadow-lg rounded-lg" data-aos="fade-left" data-aos-easing="linear"
     data-aos-duration="1500">
